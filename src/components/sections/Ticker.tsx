...
export const Ticker = () => {
  return (
    <section className="relative border-y border-gold/15 bg-noir-soft/60 backdrop-blur-md overflow-hidden py-5">
      ...
      <div className="marquee gap-12">
        {[...items, ...items].map((it, i) => (
          <span key={i} className="font-eyebrow text-[11px] text-gold/90 flex items-center gap-12 shrink-0">
            {it}
